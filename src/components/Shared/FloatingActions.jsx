  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] flex flex-col gap-4">
      ...
      <a 
        ...
        className="group relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] transition-all hover:scale-110 active:scale-95"
      >
      ...
      <button 
        ...
        className="group relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-zinc-950 text-white rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.2)] border border-white/10 transition-all hover:scale-110 active:scale-95"
      >
        <Headset size={24} />
        <span className="absolute right-16 px-4 py-2 bg-zinc-900 text-white text-[10px] font-black uppercase tracking-widest rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Live Support
