        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {team.map((member, i) => (
            ...
            >
              ...
              <div className="p-6">
                <p className="text-primary-600 text-[11px] font-black uppercase tracking-[0.2em] mb-2">{member.role}</p>
                <h4 className="text-2xl font-black text-slate-900 mb-3 group-hover:text-primary-600 transition-colors">{member.name}</h4>
        ...
        <div className="mt-24 p-2 rounded-[3rem] bg-slate-900 shadow-2xl relative overflow-hidden group">
           ...
           <div className="bg-[#050A15] rounded-[2.5rem] p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 border border-slate-800">
             ...
             <Link 
                ...
                className="whitespace-nowrap px-8 py-4 bg-white text-slate-900 font-black rounded-2xl hover:bg-primary-500 hover:text-white hover:-translate-y-1 transition-all shadow-xl shadow-white/10 uppercase text-xs tracking-[0.2em] flex items-center gap-2"
             >
