      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="mt-24 relative rounded-[3rem] bg-slate-900 p-1 overflow-hidden group">
          <div className="bg-slate-900 rounded-[2.8rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            {/* Link redirect to Contact form */}
            <Link
              smooth
              to="/contact#contact-form"
              className="relative px-10 py-4 bg-primary-600 text-white font-black rounded-2xl hover:bg-primary-500 transition-all shadow-xl shadow-primary-600/30 group-hover:scale-105 overflow-hidden flex items-center justify-center"
            >
