...
import heroimg from "../../assets/herosection-img/hero-img.avif" // Aapki image imported hai
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start mt-4 lg:mt-0">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-600 mb-8 lg:mb-10 max-w-xl 2xl:max-w-2xl leading-relaxed font-light px-2 sm:px-0">
              Your ultimate destination for all home and office services. Explore our 
              extensive collection of expert solutions for a spotless and well-maintained space.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0">
              ...
              {/* Cleaned up "Get Free Quote" Button */}
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 sm:py-4 text-base text-slate-700 font-semibold rounded-xl bg-white border border-slate-200 hover:border-primary-200 hover:bg-primary-50 transition-all hover:-translate-y-1">
                Get Free Quote
              </button>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0 relative px-4 sm:px-0">
            {/* Perfectly constrained circular image wrapper with Responsive Sizes */}
