...
const ServicesSection = ({ servicesData }) => {
  ...
  const defaultServices = [
    ...
    { id: 3, title: 'Plumbing Solutions', desc: 'Quick fixes for leaks, pipe bursts, blockages, and new bathroom fittings.', icon: 'wrench', image: plumbing, color: 'orange' },
    { id: 4, title: 'Electrical Repairs', desc: 'Safe and reliable electrical wiring, switchboard repairs, and installations.', icon: 'zap', image: Electric, color: 'yellow' },
    { id: 5, title: 'Handyman Services', desc: 'Furniture assembly, TV mounting, drilling, and general home repairs.', icon: 'home', image: handy, color: 'indigo' },
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-52 right-8 z-20">
                    <div className={`w-14 h-14 rounded-full bg-gradient-to-br ${style.gradient} flex items-center justify-center shadow-lg shadow-${service?.color || 'blue'}-500/30 border-4 border-white transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12`}>
                ...
                <div className="relative z-10 p-6 sm:p-8 pt-10 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-6">
                    <button 
                      onClick={(e) => { e.preventDefault(); console.log(`Viewing ${service?.title}`); }}
                      className="flex items-center gap-2 text-[15px] font-bold text-slate-700 transition-colors"
                    >
