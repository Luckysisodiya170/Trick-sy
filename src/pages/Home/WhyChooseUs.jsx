...
const WhyChooseUs = () => {
  const features = [
    { id: 1, title: 'Professional Team', icon: ShieldCheck, desc: 'Certified & verified experts.' },
    { id: 2, title: 'Eco-Friendly Products', icon: Leaf, desc: 'Safe for kids and pets.' },
    { id: 3, title: 'Affordable Prices', icon: BadgeDollarSign, desc: 'No hidden or extra costs.' },
    { id: 4, title: 'Fast Service', icon: Zap, desc: 'Quick & on-time response.' },
    { id: 5, title: '24/7 Support', icon: Headphones, desc: 'Always here to help you.' },
  ];
    ...
    <section className="py-16 lg:py-20 bg-white relative overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          {/* Right Side: Sleek Black Cards with Green Highlights */}
          <div className="w-full lg:w-6/12 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {index === 0 && <p className="text-slate-400 text-sm font-medium mt-1">{f.desc}</p>}
                  </div>
            ...
            {/* A small trust badge at the end of the grid */}
