...
const TechnicalDisplay = ({ service, isActive }) => {
  return (
    ...
    >
      ...
      {/* Floating Star Badge */}
      <div className="absolute top-10 right-10 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-xl flex items-center gap-2 animate-bounce">
        <Star className="text-amber-400 fill-amber-400" size={16} />
        <span className="text-white font-black text-xs uppercase tracking-widest">Top Rated Service</span>
      </div>
        ...
        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 p-10 rounded-[3rem] shadow-2xl relative overflow-hidden group/box">
          ...
          <div className="relative z-10">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-4 bg-white text-zinc-950 px-10 py-5 rounded-2xl font-black uppercase text-xs tracking-[0.2em] hover:bg-emerald-500 hover:text-zinc-950 transition-all shadow-xl"
            >
